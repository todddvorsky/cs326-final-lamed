...
window.addEventListener('load', async function () {
	...
	document
		.getElementById('change-profile-btn')
...
async function initiateButtonEvents() {
	document
		.getElementById('sunBtn')
		.addEventListener('click', async function () {
			currentDayClicked = 'sunday';
			document.getElementById('day_txt').innerHTML = document.getElementById(
				'sunBtn'
			).innerHTML;
			thisDaysDietWorkout('sunday');
		});
	document
		.getElementById('monBtn')
		.addEventListener('click', async function () {
...
function populateChangingInfo() {
	document.getElementById('change_username').value = document.getElementById(
		'pro_username'
	).innerHTML;
	document.getElementById('change_age').value = document.getElementById(
		'pro_age'
	).innerHTML;
	document.getElementById('change_country').value = document.getElementById(
		'pro_country'
	).innerHTML;
	document.getElementById('change_goalweight').value = document.getElementById(
		'pro_goalweight'
	).innerHTML;
	document.getElementById('change_about').value = document.getElementById(
		'about_me'
	).innerHTML;
	document.getElementById('change_favgym').value = document.getElementById(
		'pro_favgym'
	).innerHTML;
	document.getElementById('change_favworkout').value = document.getElementById(
		'pro_favworkout'
	).innerHTML;
	document.getElementById('change_favrecipe').value = document.getElementById(
		'pro_favrecipe'
	).innerHTML;
}
...
async function populateDietList() {
	...
	for (const diet of diets) {
		...
		newName.addEventListener('click', async function () {
			...
			document.getElementById('diet_dropdownMenuButton').innerHTML =
				newName.innerHTML;
...
async function populateWorkoutList() {
	...
	for (const wo of workouts) {
		...
		newName.addEventListener('click', async function () {
			...
			document.getElementById('WO_dropdownMenuButton').innerHTML =
				newName.innerHTML;
